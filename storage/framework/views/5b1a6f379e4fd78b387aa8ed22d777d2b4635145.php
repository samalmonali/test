...
<div>
    ...
    <form method="post" action="/reg" id="1">
        ...
        Name:<input type="text" name="name" placeholder="Enter your name" value="<?php echo old('name'); ?>" ><span class="error" style="color:darkred"><?php echo e($errors->first('name')); ?></span><br><br>
